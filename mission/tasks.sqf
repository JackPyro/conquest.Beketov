...
[EAST, "task_1", ["Дожидайтесь вражеского конвоя и захватите грузовик с патронами. Затем привезите его на базу.", "Выполните задание"], nil, "ASSIGNED", 0, true, "default"] call BIS_fnc_taskCreate;
